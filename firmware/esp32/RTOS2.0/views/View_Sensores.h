...
/**
 * =================================================================================
 * VISTA: ESTADO DE SENSORES (View_Sensores.h) — Versión RTOS 2.0
 * =================================================================================
...
/* Summary Box - Frosted Glassmorphism */
.summary{display:flex;align-items:center;justify-content:space-between;margin-bottom:16px;padding:20px 24px;background:rgba(15,23,42,0.65);backdrop-filter:blur(16px);-webkit-backdrop-filter:blur(16px);border-radius:18px;border:1px solid rgba(255,255,255,0.08);box-shadow:0 8px 24px rgba(0,0,0,0.4),inset 0 1px 0 rgba(255,255,255,0.06);flex-wrap:wrap;gap:14px;}
...
.btn-scan:hover:not(:disabled){background:linear-gradient(135deg,#0369a1,#1d4ed8);transform:translateY(-1px);box-shadow:0 6px 22px rgba(37,99,235,0.45);}
...
/* Sensor Card - Classic Frosted Glassmorphism */
.s-card{background:rgba(15,23,42,0.65);backdrop-filter:blur(12px);-webkit-backdrop-filter:blur(12px);border-radius:14px;padding:16px 14px;border:1px solid rgba(255,255,255,0.08);box-shadow:0 6px 20px rgba(0,0,0,0.35);transition:all 0.3s;text-align:center;border-left:4px solid #334155;position:relative;}
...
/* LED Legend Section */
.led-box{background:rgba(15,23,42,0.65);backdrop-filter:blur(16px);-webkit-backdrop-filter:blur(16px);border-radius:18px;border:1px solid rgba(255,255,255,0.08);padding:22px 20px;box-shadow:0 8px 24px rgba(0,0,0,0.4);}
  ...
  <div class='container'>
    <div class='hdr'>
      ...
      <div style='text-align:center'>
        ...
        <span class='hdr-sub'>I2C &middot; SPI &middot; 8 PERIF&Eacute;RICOS &middot; RTOS 2.0</span>
      </div>
