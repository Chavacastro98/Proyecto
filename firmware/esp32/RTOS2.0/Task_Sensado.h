 ...
 * 1. Muestreo de Sonda de pH Dedicada (ADS1115 Canal A1 @ 860 SPS - Canal A0 Eliminado):
 *    Cuando el módulo de pH está activo (phModuloActivo = true), ejecuta lecturas
 *    cada 20 ms (1 tick) de forma continua en Canal A1, promediando 10 muestras y aplicando
 *    un filtro no lineal de mediana de 3 puntos junto con filtro pasabajas adaptativo.
