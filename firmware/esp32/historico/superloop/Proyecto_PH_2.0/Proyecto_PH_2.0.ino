/**
 * =================================================================================
 * PROYECTO PRINCIPAL DE ELECTRODEPOSICIÓN — Versión 2.0 (Proyecto.ino)
 * =================================================================================
...
volatile float v11_1 = 1.3f;              // Voltaje pH 11 (valor inicial razonable)
...
void setup() {
  ...
  Serial.println(" FIRMWARE v2.0 — MÓDULO PH AVANZADO              ");
  Serial.println("==================================================");
  ...
  v11_1 = memoria.getFloat("v11_1", 1.3f);
  ...
  v11_2 = memoria.getFloat("v11_2", 1.3f);
  ...
  Serial.println("==================================================");
  Serial.println(" SISTEMA OPERATIVO Y EN LÍNEA - ESP32 v2.0        ");
  Serial.println("==================================================\n");
}
