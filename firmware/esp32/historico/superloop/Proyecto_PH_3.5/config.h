...
/**
 * =================================================================================
 * CONFIGURACIÓN GLOBAL DEL SISTEMA (config.h) — Versión 3.5
 * =================================================================================
...
extern volatile float
    v10_1; // Voltaje medido al sumergir en solución pH 10.0 (3 puntos)
extern volatile float
    m_ph1; // Pendiente lineal de calibración 2 puntos (pH/Voltio)
extern volatile float
    mAcida1; // Pendiente ácida para 3 puntos: (4-7)/(V4-V7) [pH/V]
extern volatile float
    mBasica1; // Pendiente básica para 3 puntos: (10-7)/(V10-V7) [pH/V]
...
extern volatile int
    amplitudDAC; // Valor digital efectivo enviado al DAC (0-4095)
extern volatile int
    amplitudDAC_Setpoint; // Consigna digital deseada antes de compensación
