...
void inicializarModuloPH() {
  ...
  if (Wire.endTransmission() == 0) {
    ...
    adsConectado = false;
    Serial.println("[PH] ⚠️ Advertencia: ADC ADS1115 no detectado en I2C (0x48). Modo seguro activo.");
  }
}
 ...
 *                  Usa buffers pH 4, 7 y 10 para máxima precisión.
 *
 ...
 *    0-60°C, pero las tinas pueden superar los 85°C.
