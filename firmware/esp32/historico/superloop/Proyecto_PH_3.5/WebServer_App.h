...
/**
 * =================================================================================
 * SERVIDOR WEB Y API DE CONTROL — Versión 3.1 (WebServer_App.h)
 * =================================================================================
 ...
 * JavaScript/Fetch).
 *
 * LISTADO DE RUTAS DISPONIBLES (v3.0):
 * ---------------------------------------------------------------------------------
 ...
 * "/update"       | Página   | ⚡ OTA: Actualización de firmware vía web (v3.0)
 ...
 * "/do_cal_ph"    | Comando  | Calibrar punto pH (?id=1/2&p=4/7/10)
 *                 |          | Retorna JSON con voltaje y pendiente calculada
 * "/ota_check"    | JSON     | ⚡ Estado de interlock OTA y versión firmware (v3.0)
 * "/sensores"     | Página   | 🔍 Diagnóstico de sensores I2C/SPI (v3.1)
 * "/data_sensors" | JSON     | 🔍 Estado de los 8 periféricos del sistema (v3.1)
 * ---------------------------------------------------------------------------------
 */
...
/** Genera la página de Diagnóstico de Sensores ("/sensores") — v3.1 */
void handleSensores();
