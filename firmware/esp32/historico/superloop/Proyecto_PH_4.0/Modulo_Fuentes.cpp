...
/**
 * =================================================================================
 * IMPLEMENTACIÓN DE LA FUENTE DE CORRIENTE — Modulo_Fuentes.cpp (Versión 4.0)
 * =================================================================================
 ...
 *    - Protocolo Zero-Current Switching (ZCS): Conmutación sin arco mecánico.
...
void actualizarSensadoVCSS() {
  ...
  if (Wire.endTransmission() != 0) {
    return; // ADS1115 no conectado, omitir sensado para evitar congelamiento
  }
...
bool autoCalibrarVCSS() {
  ...
  Wire.beginTransmission(0x48);
  if (Wire.endTransmission() != 0) {
    Serial.println("[VCSS] ❌ Error: ADC ADS1115 no detectado en I2C (0x48) para auto-calibración.");
    return false;
  }
