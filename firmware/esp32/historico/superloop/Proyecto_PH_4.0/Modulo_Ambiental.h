...
/**
 * =================================================================================
 * MÓDULO DE MONITOREO AMBIENTAL (Modulo_Ambiental.h) — Versión 4.0
 * =================================================================================
...
// Banderas de inicialización de sensores (usadas por el diagnóstico v4.0)
 ...
 * posibles.
 * @return true si ambos sensores se encontraron correctamente, false si alguno falló.
 */
