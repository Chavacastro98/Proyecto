...
// =================================================================================
// PARÁMETROS DE CONTROL PI DE CORRIENTE Y MUESTREO ETS (RTOS 1.3)
// =================================================================================
#define VCSS_PI_BLANKING_MS   2000UL // 2.0s de tiempo de gracia tras encendido (PI inactivo contra inrush)
...
#define VCSS_PI_KI            0.03f  // Ganancia Integral para anulación de error estático
