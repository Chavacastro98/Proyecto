/**
 * =================================================================================
 * PROYECTO PRINCIPAL DE ELECTRODEPOSICIÓN — Versión RTOS 1.3 (RTOS1.3.ino)
 *
 * NOVEDADES v1.3 (Control PI VCSS, Inrush Blanking & Muestreo ETS):
 *   • Soft-Start (500 ms) y Blanking Time (2000 ms) para eliminación total de picos de inrush
 *   • Lazo PI discreto suave con Anti-Windup (+-0.15A) y banda muerta (+-10 mA) en DC
 *   • Inhibición estricta de compensación PI durante pulsado (previene windup en valles de 0A)
 *   • Reconstrucción de onda ETS (Equivalent Time Sampling) estroboscópica (16 puntos)
 *   • Diagnóstico continuo de salud de celda (detección de saturación por cumplimiento y desbalance)
 *   • Telemetría de shunts I1/I2 y voltajes Vs1/Vs2 expuestos en endpoints REST y CSV
 * =================================================================================
