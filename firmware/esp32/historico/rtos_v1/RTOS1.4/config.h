...
// =================================================================================
// PARÁMETROS DE CONTROL PI DE CORRIENTE Y MUESTREO ETS (RTOS 1.4)
// =================================================================================
#define VCSS_PI_BLANKING_MS   300UL  // 300 ms de asentamiento analógico (acelera estabilización de 30s a < 2.5s)
#define VCSS_SOFT_START_MS    500UL  // 500 ms de rampa suave para evitar sobreimpulsos inductivos
#define VCSS_PI_KP            0.12f  // Ganancia Proporcional para aproximación asintótica
#define VCSS_PI_KI            0.04f  // Ganancia Integral para anulación de error estático (Ts = 100 ms)
...
enum EstadoPI_t : uint8_t {
  ...
  PI_STATE_RAMP      = 1, // Rampa de Soft-Start activa
  PI_STATE_BLANKING  = 2, // Espera de asentamiento analógico (lazo abierto seguro)
  PI_STATE_LOCKED    = 3  // Lazo PI activo y enganchado con error < 10 mA
};
...
extern volatile float   voltajeADC1, voltajeADC2;       /**< Voltaje analógico en entrada ADS1115 (V) */
extern volatile float   voltajeSonda1, voltajeSonda2;   /**< Voltaje real acondicionado de sonda (V) */
