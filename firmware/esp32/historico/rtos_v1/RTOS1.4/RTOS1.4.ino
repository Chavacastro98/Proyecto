/**
 * =================================================================================
 * PROYECTO PRINCIPAL DE ELECTRODEPOSICIÓN — Versión RTOS 1.4 (RTOS1.4.ino)
 *
 * NOVEDADES v1.4 (Desacoplamiento VCSS, Single-Writer & Rampa Rápida < 2.5s):
 *   • Arquitectura desacoplada en Modulo_Fuente_DC y Modulo_Fuente_Pulsado
 *   • Single-Writer Pattern: Task_Fuente es el único hilo ejecutor de potencia
 *   • Task_Sensado 100% liberada de la etapa VCSS (cero contención I2C con pH)
 *   • Rampa DC acelerada: de 30s a < 2.5s mediante control PI adaptativo por zonas a 10 Hz
 *   • Blanking reducido a 300 ms con enganche estático en banda muerta (+-10 mA)
 *   • Modo pulsado con amplitud directa en flanco alto y muestreo estroboscópico ETS aislado
 *   • Enclavamiento estricto de autocalibración de shunts (bloqueada si la fuente está activa)
 * =================================================================================
...
volatile float   voltajeADC1 = PH_OFFSET_TEORICO, voltajeADC2 = PH_OFFSET_TEORICO; /**< Voltajes en entrada ADC */
volatile float   voltajeSonda1 = 2.50f, voltajeSonda2 = 2.50f; /**< Voltajes reales acondicionados de sonda */
