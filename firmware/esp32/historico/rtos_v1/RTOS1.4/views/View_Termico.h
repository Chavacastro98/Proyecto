...
/**
 * =================================================================================
 * VISTA: CONTROL TÉRMICO (View_Termico.h) — Versión RTOS 1.1
 * =================================================================================
 * MEJORAS v1.1:
 ...
 *   • Micro-animaciones en cambio de estado (activo/reposo)
 *   • Toast notifications reemplazando alert()
 *   • Código de color inteligente: azul(frío) → amarillo(calentando) → verde(en SP) → rojo(error)
...
/* Summary Bar */
.sum-bar{display:flex;align-items:center;justify-content:space-between;padding:12px 18px;margin-bottom:16px;background:rgba(15,23,42,0.65);border-radius:14px;border:1px solid rgba(56,189,248,0.08);font-size:0.78em;font-weight:700;color:#94a3b8;flex-wrap:wrap;gap:8px;}
.sum-pill{display:inline-flex;align-items:center;gap:5px;padding:4px 10px;border-radius:20px;font-size:0.85em;font-weight:800;}
.sum-pill.active{background:rgba(5,150,105,0.15);color:#34d399;border:1px solid rgba(52,211,153,0.3);}
...
/* Card */
.card{background:linear-gradient(165deg,rgba(30,41,59,0.95),rgba(15,23,42,0.9));border-radius:18px;padding:20px;border:1px solid rgba(56,189,248,0.1);box-shadow:0 6px 24px rgba(0,0,0,0.4),inset 0 1px 0 rgba(255,255,255,0.03);transition:all 0.35s;position:relative;border-left:4px solid #38bdf8;}
