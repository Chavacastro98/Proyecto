...
/**
 * =================================================================================
 * VISTA: ESTADO DE SENSORES (View_Sensores.h) — Versión RTOS 1.0
 * =================================================================================
...
/* Sensor Card */
.s-card{background:linear-gradient(165deg,rgba(30,41,59,0.95),rgba(15,23,42,0.9));border-radius:14px;padding:16px 14px;border:1px solid rgba(51,65,85,0.4);box-shadow:0 4px 18px rgba(0,0,0,0.3);transition:all 0.3s;text-align:center;border-left:4px solid #334155;position:relative;}
