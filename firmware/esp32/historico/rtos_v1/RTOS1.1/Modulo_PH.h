...
/**
 * @brief Realiza una lectura de alta precisión (20 muestras) en A0 para diagnóstico en consola web.
...
/**
 * @brief Registra un punto de calibración (pH 4, 7 o 10), recalcula pendientes y guarda en Flash NVS.
 * @param tina Número de tina (1 o 2).
 * @param punto Valor del buffer estándar (4, 7 o 10).
 * @return true si la calibración fue aceptada; false si el voltaje medido estuvo fuera de rango.
 */
