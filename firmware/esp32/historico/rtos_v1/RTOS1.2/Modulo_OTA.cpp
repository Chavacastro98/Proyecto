/**
 * =================================================================================
 * MÓDULO DE ACTUALIZACIÓN INALÁMBRICA OTA (Modulo_OTA.cpp) — Versión RTOS 1.0
 * =================================================================================
...
.ota-card{background:linear-gradient(165deg,rgba(30,41,59,0.95),rgba(15,23,42,0.92));padding:28px 24px;border-radius:22px;box-shadow:0 16px 45px rgba(0,0,0,0.55),inset 0 1px 0 rgba(255,255,255,0.05);width:100%;max-width:520px;border:1px solid rgba(56,189,248,0.12);text-align:center;}
    ...
    <div class='ota-card'>
        <div class='hdr'>
            ...
            <div style='text-align:center'>
                ...
                <span class='hdr-sub'>CARGA INAL&Aacute;MBRICA OTA &middot; ESP32-S3</span>
            </div>
            <div></div>
        </div>
        ...
        <div class='ver-wrap'>
            ...
            <span class='ver-badge'>Versi&oacute;n: v<span id='cur-ver'>%FIRMWARE_VER%</span></span>
        </div>
        ...
        <div class='drop-zone' id='dz' onclick='document.getElementById("fi").click()'>
            ...
            <div class='drop-sub'>o haga clic para seleccionar desde su equipo</div>
        </div>
