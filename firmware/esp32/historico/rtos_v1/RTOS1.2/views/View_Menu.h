...
/**
 * =================================================================================
 * VISTA: MENÚ PRINCIPAL (View_Menu.h) — Versión RTOS 1.1
 * =================================================================================
...
<body>
    <div class='menu-card'>
        ...
        <div class='sub-title'>Sistema de Electrodeposici&oacute;n &middot; RTOS 1.1</div>
    ...
    <script>
        ...
        function updLiveStatus(){
            ...
            fetch('/get_ph_dual').then(function(r){return r.json();}).then(function(d){
                ...
                if(d.on==1){
                    el.innerText='Zinc:'+parseFloat(d.p1).toFixed(1)+' | Ni:'+parseFloat(d.p2).toFixed(1);
                    el.className='proc-live active';
                }else{
